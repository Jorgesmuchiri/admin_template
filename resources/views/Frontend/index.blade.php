...
<head>
    ...
    <meta name="description" content="Education master">
        ...
        <div class="ed-mob-menu">
            <div class="ed-mob-menu-con">
                <div class="ed-mm-left">
                    <div class="wed-logo">
                        <a href="index.html"><img src="images/Newlogo.png" alt="" />
                        </a>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="ed-com-t1-left">
                            <ul>
                                ...
                                <li><a href="#">Phone: (+254)799487244 or (+254)722596124 or or 0204914011</a>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="top-logo" data-spy="affix" data-offset-top="400">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="wed-logo">
                            <a href="index.html"><img src="images/elearning _logo.png" alt="" />
                            </a>
                        </div>
                        <div class="main-menu">
                            <ul>
                                        ...
                                        <div class="about-mm m-menu">
                                            <div class="m-menu-inn">
                                                ...
                                                <div class="mm1-com mm1-s2">
                                                    ...
                                                    <a href="principal.html" class="mm-r-m-btn">Read more</a>
                                                </div>
                                                ...
                                                <div class="mm1-com mm1-s4">
                                                    <ul>
                                                        ...
                                                        <li><a href="elearning.html">E-Learning Capacity</a></li>
                                ...
                                <li class="admi-menu">
                                    <a href="admissions/index.html" class="mm-arr">Admission</a>
                                    <!-- MEGA MENU 1 -->
                                   <!--  <div class="mm-pos">
                                ...
                                <li class="cour-menu">
                                    <a href="Partners.html" class="mm-arr">Partners</a>
                                    <!-- MEGA MENU 1 -->
                                   <!--  <div class="mm-pos">
                                            ...
                                            <div class="m-menu-inn">
                                                ...
                                                <div class="mm1-com mm1-cour-com mm1-s3">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="admin-page-all.html">Partners</a></li>
                        ...
                        <div class="search-form">
                            <form>
                                <div class="sf-type">
                                    ...
                                    <div class="sf-list">
                                        <ul>
                                            <li><a href="">POST MASTERS FELLOWSHIP
                                            </a></li>
                                            <li><a href="">Monitoring and Evaluation (PMF)
                                            </a></li>
                                            <li><a href="">Health Economics (PMF)</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="h2-hero-inn">
                        ...
                        <div class="con-title">
                            <h1 style="color: #ffffff">Welcome to the College of Health Sciences </h1>
                            <h1 style="color: #ffffff">e-Learning Portal</h1>
                        </div>
                        <div class="con-title">

                            <p style="color: #ffffff"><b><i>"Bringing learning closer to you, at your convenience"</i><b></p>
                            </b>
    ...
    <div class="container">
        <div class="row">
            <div class="wed-hom-ser">
                <ul>
                    <li>
                        <a href="academics.html" class="waves-effect waves-light btn-large wed-pop-ser-btn"><img src="images/icon/h-ic1.png" alt=""> Academics</a>
                    </li>
                    <li>
                        <a href="admission/index.html" class="waves-effect waves-light btn-large wed-pop-ser-btn"><img src="images/icon/h-ic2.png" alt=""> Admission</a>
                    </li>
                    <li>
                        <a href="all-courses.html" class="waves-effect waves-light btn-large wed-pop-ser-btn"><img src="images/icon/h-ic3.png" alt=""> Courses</a>
                    </li>
                    <li>
                        <a href="announcements.html" class="waves-effect waves-light btn-large wed-pop-ser-btn"><img src="images/icon/h-ic3.png" alt=""> Announcements</a>
                    </li>
                </ul>
            </div>
        </div>
...
<section>
        ...
        <div class="row">
            <div class="ed-course">
                    <!-- <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="PostMastersFellowship.html">
                                <img src="https://image.flaticon.com/icons/svg/806/806180.svg" alt="">
                                <span>Post Masters Fellowship</span>
                            </a>
                        </div>
                    </div> -->
                  <!--   <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="">
                                <img src="https://image.flaticon.com/icons/svg/2083/2083228.svg" alt="">
                  ...
                  <!--   <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="UNITID Certificate.html">
                                <img src="https://image.flaticon.com/icons/svg/2303/2303952.svg" alt="">
                  ...
                  <!--   <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="">
                                <img src="https://image.flaticon.com/icons/svg/1575/1575109.svg" alt="">
                                <span>UCSF</span>
                            </a>
                        </div>
                    </div> -->
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="PostMasters.html">
                                <img src="https://image.flaticon.com/icons/svg/346/346102.svg" alt="">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="">
                                <img src="https://image.flaticon.com/icons/svg/2231/2231605.svg" alt="">
                                <span>NASCOP Courses</span>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="PostGraduateDiploma.html">
                                <img src="https://image.flaticon.com/icons/svg/943/943449.svg" alt="">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="UNITID Certificate.html">
                                <img src="https://image.flaticon.com/icons/svg/1945/1945897.svg" alt="">
                                <span>Certificate Courses</span>
                            </a>
                        </div>
                    </div>
    ...
    <section class="pop-cour">
        <div class="container com-sp pad-bot-70">
            ...
            <div class="row">
                @foreach($pcourses as $courses)
                <div class="col-md-6">
                    <div>
                        <!--POPULAR COURSES-->
                        <div class="home-top-cour">
                            <!--POPULAR COURSES IMAGE-->
                            <div class="col-md-3"> <img src="storage/images/{{$courses->image}}" alt=""> </div>
                            <!--POPULAR COURSES: CONTENT-->
                            <div class="col-md-9 home-top-cour-desc">
                                <a href="ProgramManagement.html">
                                    <h3></h3>
                                </a>
                                <h4>{{$courses ->course_name}}
                                </h4>
                                <p>{{$courses ->description}}</p> 
                                <div class="hom-list-share">
                                    <ul>

                                        @if($courses->status == 'Available')
                                        

                                           <li>  <a href="enrollment"><i class="fa fa-bar-chart" aria-hidden="true"></i>  Enrol Now</a>  </li>
                                       


                                       @else 
                                       <li><a href="booking"><i class="fa fa-bar-chart" aria-hidden="true"></i>  Book Now</a> </li>
                                   
                                   @endif
                                   <li><a href=""><i class="fa fa-eye" aria-hidden="true"></i>{{$courses->status}}</a> </li>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="bot-gal h-gal ho-event-mob-bot-sp">
                        ...
                        <ul>
                            <li><img class="materialboxed" data-caption="" src="images/ami/12.JPG" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="" src="images/ami/13.JPG" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="" src="images/ami/14.JPG" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="" src="images/ami/15.JPG" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="" src="images/ami/9.JPG" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="" src="images/ami/10.JPG" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="" src="images/ami/11.JPG" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="" src="images/ami/8.JPG" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="" src="images/ami/2.JPG" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="" src="images/ami/3.jpg" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="" src="images/ami/4.JPG" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="" src="images/ami/5.JPG" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="" src="images/ami/6.JPG" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="" src="images/ami/7.JPG" alt="">
                            </li>
        ...
        <div class="row wed-foot-link-1">
            ...
            <div class="col-md-4">
                ...
                <ul>
                    ...
                    <li><a href="https://twitter.com/UoN_CHS
        ...
        <div id="modal2" class="modal fade" role="dialog">
            ...
            <script type="text/javascript">
                ...
                (function(){
                    ...
                    s1.async=true;
                    s1.src='https://embed.tawk.to/5e2aec218e78b86ed8aae4f5/default';
                    s1.charset='UTF-8';
