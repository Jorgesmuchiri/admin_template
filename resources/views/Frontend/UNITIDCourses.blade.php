                            ...
                            <form>
                                <div class="sf-type">
                                    ...
                                    <div class="sf-list">
                                        <ul>
                                            <li><a href="course-details.html">Accounting/Finance</a></li>
                                <li><a href="course-details.html">Monitoring and Evaluation (PMF)
</a></li>
                                <li><a href="course-details.html">Health Economics (PMF)</a></li>
                                <li><a href="course-details.html">Epidemiology and Biostatistics (PMF)</a></li>
                                <li><a href="course-details.html">Health Economics (PMF)</a></li>
                                <li><a href="course-details.html">Epidemiology Certificate</a></li>
                                <li><a href="course-details.html"> Biostatistics
 Certificate</a></li>
                                <li><a href="course-details.html">Health Informatics Certificate</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="sf-submit">
    ...
    <!--END HEADER SECTION-->
     ...
     <section class="pop-cour">
        <div class="container com-sp pad-bot-70">
            <div class="row">
                <div class="con-title">
                    <h2>UNITID <span>Courses</span></h2>
                    ...
                    <div>
                        ...
                        <div class="home-top-cour">
                            ...
                            <div class="col-md-9 home-top-cour-desc">
                                <a href="PostMasters.html">
                                    <h3>POST MASTERS FELLOWSHIP</h3>
                                </a>
    
                               <span class="home-top-cour-rat"></span>
                                <div class="hom-list-share">
                                    <ul>
                                        <li><a href="PostMasters.html"><i class="fa fa-bar-chart" aria-hidden="true"></i> Book Now</a> </li>
                                        <li><a href="PostMasters.html"><i class="fa fa-eye" aria-hidden="true"></i> Aavailable</a> </li>
                                        <li><a href="PostMasters.html"><i class="fa fa-share-alt" aria-hidden="true"></i> </a> </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-9 home-top-cour-desc">
                                ...
                                <div class="hom-list-share">
                                    <ul>
                                        ...
                                        <li><a href=""><i class="fa fa-eye" aria-hidden="true"></i>Aavailable</a> </li>
                    ...
                    <div>
                        <!--POPULAR COURSES-->
                          <div class="home-top-cour">
                            ...
                            <!--POPULAR COURSES: CONTENT-->
                            <div class="col-md-9 home-top-cour-desc">
                                <a href="UNITID Certificate.html">
                                ...
                                <div class="hom-list-share">
                                    <ul>
                                        <li><a href="UNITID Certificate.html"><i class="fa fa-bar-chart" aria-hidden="true"></i> Book Now</a> </li>
                                        <li><a href="UNITID Certificate.html"><i class="fa fa-eye" aria-hidden="true"></i></a> </li>
                                        <li><a href="UNITID Certificate.html"><i class="fa fa-share-alt" aria-hidden="true"></i> </a> </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
