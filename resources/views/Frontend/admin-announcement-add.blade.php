            ...
            <div class="sb2-2">
                ...
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#"> Add New Announcement</a>
                        </li>
                ...
                <div class="sb2-2-3">
                    <div class="row">
						...
						<div class="box-inn-sp admin-form">
                                ...
                                <div class="tab-inn">
                               <form method="post" action="{{ route('announcement.store') }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data" >
            @csrf
            @method('post')
                                        <div class="row">
