                            ...
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    <li><a href="courses">All Course</a>
                                     ...
                                     <li><a href="add-course">Add New  Popular Course</a>
                                    </li>
                                    <li><a href="adminadd-course">Add New  Popular Course</a>
                                    </li>
                                    <li><a href="pcourses">Popular Courses</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
            ...
            <div class="sb2-2">
                ...
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="page-back"><a href="courses"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="tab-content">
                        <div id="home" class="tab-pane fade active in">
                            <div class="box-inn-sp">
                                ...
                                <div class="bor">
                                        <form method="post" action="{{ route('courses.store') }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data" >
            @csrf
            @method('post')
                                        <div class="row">
                                      ...
                                      <option value="NASCOP Course">NASCOP Course</option>
                                      ...
                                      <option value="Certificate Course">Certificate Course</option>
                                             ...
                                             <div class="row">
                                            <div class="input-field col s12">
                                                <input id="list-title" type="text" class="validate" name="duration">
                                                <label for="list-title" class="">Course Duration</label>
                                            </div>
                                        </div>
                                                <div class="row">
                                            <div class="input-field col s12">
                                                <input id="list-title" type="text" class="validate" name="start_date">
                                                <label for="list-title" class="">Start Date</label>
                                            </div>
                                        </div>

                                                <div class="row">
                                            <div class="input-field col s12">
                                                <input id="list-title" type="text" class="validate" name="end_date">
                                                <label for="list-title" class="">End Date</label>
                                            </div>
                                                  </div>

                                                    <div class="row">
                                            <div class="input-field col s12">
                                                <input id="list-title" type="text" class="validate" name="total_seat">
                                                <label for="list-title" class="">Total Seat</label>
                                            </div>
