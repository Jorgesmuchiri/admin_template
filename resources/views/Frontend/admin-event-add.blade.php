...
<body>
    <!--== MAIN CONTRAINER ==-->
  <!--== MAIN CONTRAINER ==-->
    <div class="container-fluid sb1" style="background-color: #ffffff">
        <div class="row">
            <!--== LOGO ==-->
            <div class="col-md-2 col-sm-3 col-xs-6 sb1-1">
                <a href="#" class="btn-close-menu"><i class="fa fa-times" aria-hidden="true"></i></a>
                <a href="#" class="atab-menu"><i class="fa fa-bars tab-menu" aria-hidden="true"></i></a>
                <a href="index.html" class="logo" style="color: #032147"> <img src="images/elearning _logo.png" alt="" width="" /> 
                </a>
            </div>
            <!--== SEARCH ==-->
            ...
            <div class="col-md-2 tab-hide">
                <div class="top-not-cen">
                    <a class='waves-effect btn-noti' href="admin-all-enquiry.html" title="all enquiry messages"><i class="fa fa-commenting-o" aria-hidden="true"></i></a>
                    <a class='waves-effect btn-noti' href="admin-course-enquiry.html" title="course booking messages"><i class="fa fa-envelope-o" aria-hidden="true"></i></a>
                    <a class='waves-effect btn-noti' href="admin-admission-enquiry.html" title="admission enquiry"><i class="fa fa-tag" aria-hidden="true"></i></a>
                </div>
            </div>
            <!--== MY ACCCOUNT ==-->
            <div class="col-md-2 col-sm-3 col-xs-6" style="background-color:#032147">
                <!-- Dropdown Trigger -->
                ...
                <ul id='top-menu' class='dropdown-content top-menu-sty'>
                    <li><a href="" class="waves-effect"><i class="fa fa-cogs" aria-hidden="true"></i>My Profile</a>
                    </li>
                    <li class="divider"></li>
            ...
            <div class="sb2-1">
                ...
                <div class="sb2-13">
                    <ul class="collapsible" data-collapsible="accordion">
                        <li><a href="admin"><i class="fa fa-bar-chart" aria-hidden="true"></i> Dashboard</a>
                        </li>
						
                        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-book" aria-hidden="true"></i> All Courses</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    <li><a href="all-courses.html">All Course</a>
                                    </li>
                                    <li><a href="adminadd-course">Add New Course</a>
                                    </li>
                                    <li><a href="admin-trash-courses.html">Popular Courses</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-user" aria-hidden="true"></i> Announcements</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    <li><a href="admin-user-all.html">All Announcements</a>
                                    </li>
                                    <li><a href="admin-user-add.html">Add New Announcements</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                       ...
                       <!--  <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-bars" aria-hidden="true"></i> Menu</a>
                        ...
                        <li class="menu-active"><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-calendar" aria-hidden="true"></i> Events</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    <li><a href="events">All Events</a>
                                    </li>
                                    <li><a href="admin-event-add">Create New Events</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                       ...
                       <!--  <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-graduation-cap" aria-hidden="true"></i> Job Vacants</a>
                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-commenting-o" aria-hidden="true"></i> Enquiry</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    <li><a href="admissionenquiries">All Enquiry</a></li>
            ...
            <div class="sb2-2">
                ...
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="page-back"><a href="events"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="sb2-2-3">
                    <div class="row">
						...
						<div class="box-inn-sp admin-form">
                                ...
                                <div class="tab-inn">
                               <form method="post" action="{{ route('events.store') }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data" >
            @csrf
            @method('post')
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="text" value="" name="event_name" class="validate" required> 
                                                <label class="">Event name</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                 <input type="text" value="" name="venue" class="validate" required> 
                                                <label class="">Venue</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="text" value="" class="validate"  name="event_date"  required>
                                                <label class="">Date</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input type="text" class="validate" value="" name="event_time" required>
