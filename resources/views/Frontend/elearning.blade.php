            ...
            <div class="row">
                <div class="cor about-sp">
                    <div class="ed-about-tit">
                        <div class="con-title">
                            <h2>E-Learning  <span> Capacity</span></h2>
                            <p style="text-align: justify;">The eCHS platform is built on the moodle platform. The eCHS is modeled around a web-based Learning Management System (LMS) which is also available via the moodle app. This makes it easy for many training programs offered at the CHS to be delivered through the internet, with students taking sit-in on-campus examinations at the end of each Semester. The portal supports online students’ discussion forums, interaction with the trainers, submission of assignments and exercises. The platform also has contact information for those who need personalized support.</p>
