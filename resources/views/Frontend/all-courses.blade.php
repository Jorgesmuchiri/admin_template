                                            ...
                                            <div class="m-menu-inn">
                                                <div class="mm1-com mm1-s1">
                                                    <div class="ed-course-in">
                                                        <a class="menu-about" href="admission">
            ...
            <div class="row">
                <div class="ed-course">
                    <!-- <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="PostMastersFellowship">
                  ...
                  <!--   <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="UNITID Certificate">
                  ...
                  <!--   <div class="col-md-3 col-sm-4 col-xs-12">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="PostMasters">
                                <img src="images/course_icon.jpg" alt="" height="200">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="PostGraduateDiploma">
                                <img src="https://image.shutterstock.com/image-vector/graduation-certificate-diploma-icon-white-600w-1194740545.jpg" alt="" height="250">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="UNITID Certificate">
                                <img src="images/course_icon3.png" alt="" height="250">
                                <span>Certificate Courses</span>
                            </a>
                        </div>
                    </div>
