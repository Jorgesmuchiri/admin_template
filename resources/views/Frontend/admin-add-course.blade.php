                    ...
                    <div class="tab-content">
                        <div id="home" class="tab-pane fade active in">
                            <div class="box-inn-sp">
                                ...
                                <div class="bor">
                                        <form method="post" action="{{ route('pcourses.store') }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data" >
            @csrf
            @method('post')
                                        <div class="row">
                                        ...
                                        <div class="row">
                                                ...
                                                <label for="list-title" class="">Course Icon</label>
                                            <div class="input-field col s12">
                                                <input id="list-title" type="file" class="validate" name="image">
