                ...
                <div class="sb2-13">
                    <ul class="collapsible" data-collapsible="accordion">
                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-user" aria-hidden="true"></i> Announcements</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    <li><a href="announcement">All Announcements</a>
                                    </li>
                                    <li><a href="admin-announcement-add">Add New Announcements</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                ...
                <div class="sb2-2-1">
                   ...
                   <!--  <p>The .table class adds basic styling (light padding and only horizontal dividers) to a table:</p> -->
                    <div class="db-2">
                        <ul>
                            <li>
                                <div class="dash-book" style="background-color: #ff0808">
                                    <h5>All Courses</h5>
                                    <h4>48</h4>
                                    <a href="#">View more</a>
                                </div>
                            ...
                            <li>
                                <div class="dash-book" style="background-color: #005aa3">
                                    <h5>Admission</h5>
                                    <h4>672</h4>
                                    <a href="#">View more</a>
                                </div>
                            ...
                            <li>
                                <div class="dash-book" style="background-color: #a30082">
                                    <h5>Students</h5>
                                    <h4>689</h4>
                                    <a href="#">View more</a>
                                </div>
                            ...
                            <li>
                                <div class="dash-book" style="background-color: #0c4700">
                                    <h5>Enquiry</h5>
                                    <h4>24</h4>
                                    <a href="#">View more</a>
                                </div>
